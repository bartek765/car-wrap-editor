...
Command: npx gltfjsx@6.5.3 public/models/ferrari.glb --output src/models/Ferrari.tsx --types 
*/
...
type GLTFResult = GLTF & {
  nodes: {
    trim: THREE.Mesh
    lights_red: THREE.Mesh
    plastic_gray: THREE.Mesh
    metal: THREE.Mesh
    lights: THREE.Mesh
    leds: THREE.Mesh
    leather: THREE.Mesh
    ...
    chrome: THREE.Mesh
    carpet: THREE.Mesh
    carbon_fibre_trim: THREE.Mesh
    carbon_fibre: THREE.Mesh
    brakes: THREE.Mesh
    interior_dark: THREE.Mesh
    body: THREE.Mesh
    blue: THREE.Mesh
    wipers: THREE.Mesh
    yellow_trim: THREE.Mesh
    wheel: THREE.Mesh
    tire: THREE.Mesh
    rim_rr: THREE.Mesh
    centre: THREE.Mesh
    ...
    tire_3: THREE.Mesh
    nuts_3: THREE.Mesh
    steering_carbon: THREE.Mesh
    steering_centre: THREE.Mesh
    steering_column: THREE.Mesh
    steering_leather: THREE.Mesh
    steering_metal: THREE.Mesh
    steering_red_lights: THREE.Mesh
    steering_trim: THREE.Mesh
  }
  materials: {
    Leather_red: THREE.MeshStandardMaterial
    Taillight_Glass: THREE.MeshStandardMaterial
    plastic_gray: THREE.MeshStandardMaterial
    ...
    Glass_Gray: THREE.MeshStandardMaterial
    ...
    _0098_DodgerBlue: THREE.MeshStandardMaterial
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/ferrari.glb') as GLTFResult
  return (
